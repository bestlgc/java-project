...
<body>
    ...
    <li><a href="tc_priCourseList.html">我的课件</a></li>
	<li><a href="#">课件模板</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
		<ul id="tc_find" >
			<li><lable id="tc_findLable">搜索</lable><input type="text" name="findUser" id ="findUser" value=""/><a href="#"><img src="images/ico06.png" /></a></li>
        </ul>
