...
<body>
    ...
    <form action="saveTask.html" method="post">
	...
	<li><label>任务标题<b>*</b></label><input name="title" type="text" class="dfinput" value=""  style="width:518px;"/></li>
   
    <li><label>科目<b>*</b></label>  
    <div class="vocation">
    <select  name="subject" class="select1">
    ...
    <#list teacherlist.viewlist as teacher>
	<input type="checkbox" name="teachers" value="${teacher.id}" />${teacher.name}
	</#list>
