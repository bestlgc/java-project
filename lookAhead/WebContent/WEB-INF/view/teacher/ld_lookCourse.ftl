...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class=""><a href="ld_courseList.html"><span><img src="images/t01.png" /></span>上传课件模板</a></li>
        <li class="click">
			<span><img src="${path}/images/t02.png" /></span>课件审核</li>
        <li><span><img src="${path}/images/t03.png" /></span>删除</li>
        <li><a href="ld_message.html"><span><img src="${path}/images/t04.png" /></span>任务分配</a></li>
        </ul>
    ...
    <th>发布人</th>
    <th>		
		<SELECT id="droplist" class="sel" onchange="#"> 
			<OPTION selected>－课件状态－</OPTION> 
